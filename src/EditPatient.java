...
public class EditPatient implements ActionListener{
...
//		nextButton.setBackground(new Color(50, 50, 225));
		...
		frame.setTitle("Add New Patient-Information");       //Set title of this
		...
		*/
		...
		dobLabel.setBounds(50, 110, 130, 20);
		...
		frame.setSize(450, 600);					// sets dimensions of window(x,y)
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);    // exit out of application
